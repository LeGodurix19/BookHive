...
class ManageFollowingsPage extends StatelessWidget {
  ...
  ManageFollowingsPage({super.key, this.userId});
        ...
        builder: (context, snapshot) {
          ...
          return ListView.builder(
            ...
            itemBuilder: (context, index) {
              ...
              final followingUserId = following.id;
              ...
              return FutureBuilder<DocumentSnapshot>(
                ...
                builder: (context, userSnapshot) {
                  ...
                  return ListTile(
                    ...
                    trailing: userId == ownUID // Ajout de la condition pour afficher les boutons de suppression et de blocage
                     ? Row(
